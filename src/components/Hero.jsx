    ...
    return (
        <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
            <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
                ...
                <div 
                    className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2 animate__animated animate__headShake animate__infinite animate__slow"
                >
                ...
                <div className="flex flex-row justify-between items-center w-full">
                    ...
                    <div className="animate__animated animate__pulse animate__slow animate__infinite ss:flex hidden md:mr-4 mr-0">
                        <GetStarted />
                    </div>
                </div>
            ...
            <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
                ...
                <div className="absolute z-[1] w-[80%] h-[80%] rounded-full white__gradient bottom-100" />
